...
public class User implements Serializable {
     ...
     * 用户所在根机构
     */
    private Integer organRootId;

    /**
     * 用户所在根机构名称
     */
    private String organRootName;
    ...
    public Integer getOrganRootId() {
        return organRootId;
    }

    public void setOrganRootId(Integer organRootId) {
        this.organRootId = organRootId;
    }

    public String getOrganRootName() {
        return organRootName;
    }

    public void setOrganRootName(String organRootName) {
        this.organRootName = organRootName;
    }
